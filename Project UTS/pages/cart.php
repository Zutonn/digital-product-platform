    ...
    <div class="container">
            ...
            <div class="cart-layout">
                    ...
                    <?php while ($item = $cart_items->fetch_assoc()): ?>
                        ...
                        <div class="cart-item <?= $out_of_stock ? 'out-of-stock' : '' ?>">
                            <div class="cart-item-image">
                                ...
                                <?php else: ?>
                                    <div class="placeholder-image-small"><i class="fas fa-image"></i></div>
                                <?php endif; ?>
                            </div>
                            ...
                            <div class="cart-item-info">
                                ...
                                <?php if ($out_of_stock): ?>
                                    <div class="stock-warning"><i class="fas fa-exclamation-triangle"></i> Stok Habis</div>
                                <?php endif; ?>
                            </div>
                            ...
                            <div class="cart-item-actions">
                                <form method="post" style="display: inline;">
                                    ...
                                    <button type="submit" name="remove_from_cart" class="btn btn-danger btn-sm" onclick="return confirm('Hapus?')">
                ...
                <div class="cart-summary-section">
                    <div class="cart-summary">
                        ...
                        <div class="summary-row"><span>Subtotal (<?= $items_count ?> item)</span><span><?= formatRupiah($subtotal) ?></span></div>
                        <div class="summary-row"><span>Biaya Admin</span><span>Rp 0</span></div>
                        <hr>
                        <div class="summary-row total"><span>Total</span><span><?= formatRupiah($subtotal) ?></span></div>
                        <a href="index.php?page=checkout" class="btn btn-primary btn-lg btn-block"><i class="fas fa-credit-card"></i> Checkout</a>
                        <a href="index.php?page=shop" class="btn btn-outline btn-block"><i class="fas fa-arrow-left"></i> Lanjut Belanja</a>
                    </div>
        ...
        <?php else: ?>
            <div class="empty-state">
                ...
                <a href="index.php?page=shop" class="btn btn-primary"><i class="fas fa-shopping-bag"></i> Mulai Belanja</a>
            </div>
        <?php endif; ?>
